...
//	@WithMockUser
	public void testUpdateWalletChange() throws Exception {
		...
		.andExpect(jsonPath("$.erros[0]").value("Você não pode alterar a carteira"));
...
//	@WithMockUser
	public void testUpdateInvalidId() throws Exception {
		...
		.andExpect(status().isBadRequest())
		.andExpect(jsonPath("$.data").doesNotExist())
		.andExpect(jsonPath("$.erros[0]").value("WalletItem não encontrado"));
...
//	@WithMockUser(username = "admin@admin.com", roles = {"ADMIN"})
	public void testDeleteInvalid() throws Exception {
		...
		.andExpect(jsonPath("$.data").doesNotExist())
		.andExpect(jsonPath("$.erros[0]").value("WalletItem de id "+ 99 + " não encontrada"));
